...
%          'nativemeta', nativemeta );
    ...
    foldermeta.banks = helper_addChannelFileBanks( ...
      ...
      'int16', 0, voltages.amplifier_scale, '', noflags );
    ...
    foldermeta.banks = helper_addChannelFileBanks( ...
      ...
      'uint16', 0, voltages.aux_scale, '', noflags );
    ...
    foldermeta.banks = helper_addChannelFileBanks( ...
      ...
      'uint16', voltages.dcamp_zerolevel, voltages.dcamp_scale, '', noflags );
    ...
    foldermeta.banks = helper_addChannelFileBanks( ...
      ...
      voltages.board_analog_scale, '', noflags );
    ...
    foldermeta.banks = helper_addChannelFileBanks( ...
      ...
      'int16', 0, stim_step_size, 'stimcurrent', noflags );
    ...
    foldermeta.banks = helper_addChannelFileBanks( ...
      ...
      'uint16', 0, voltages.supply_scale, '', noflags );
...
function newbanks = helper_addChannelFileBanks( ...
  ...
  nativetype, zerolevel, scale, specialtype, flagdefs )
